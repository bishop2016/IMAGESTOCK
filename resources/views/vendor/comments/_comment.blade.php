...
@endif
@foreach (Auth::user()->posts as $role) <img class="mr-3" src="/storage/{{$role->image}} " style="max-width:40px;" class="rounded-circle w-100" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">@endforeach
